...
//Proses penambahan index
	...
	$stmt = $mysqli->prepare("INSERT INTO tb_mitra 
		(nik,nama,alamat,kecamatan,jk,notelepon,umur,pendidikan,jurusan,pekerjaan,gadget,pengalaman,kendaraan,rekening,idrekrutmen,idkecamatan,foto,status) 
		VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	if ($stmt->execute()) { 
		echo "<script>alert('Data mitra berhasil disimpan')</script>";
