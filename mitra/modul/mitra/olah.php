...
if(isset($_SESSION['mitra']))
	extract(_dataGetId($mysqli,"tb_mitra","idmitra='".$_SESSION['mitra']."'"));

?>

<?php
if($nik!=""){
	echo "<script>alert('Anda sudah terdatar silakan menunggu informasi lebih lanjut')</script>";
	echo "<script>window.location='index.php?hal=mitra/detail';</script>";	
}
?>
